...
public class Game1 extends JFrame{
    ...
    public static void generate(int pourcent) {
        ...
        // Place les bombes
        for (int x=0; x < Game1.nbCasesX; x++) {
            for (int y=0; y < Game1.nbCasesY; y++) {
    ...
    public static void supprCase(int x, int y) {
        ...
        if (cases[x][y] == -1) {
            for (int x1=0; x1 < Game1.nbCasesX; x1++) {
                for (int y1=0; y1 < Game1.nbCasesY; y1++) {
